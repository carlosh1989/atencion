...
//alert(tipo_id);
$.get("<?php echo baseUrl ?>fundacion/solicitudesFundacion/combo", { organismo_id:organismo_id }, function(data){
$("#OrganismosSelect").html(data);
});
$.get("<?php echo baseUrl ?>fundacion/solicitudesFundacion/categorias", { tipo_id:tipo_id }, function(data){
...
<div id="panel" class="panel panel-danger">
  ...
  <div class="panel-body">
    ...
    <?php else: ?>
    <form action="<?php echo baseUrl ?>fundacion/solicitudesFundacion/create/<?php echo $solicitante->id ?>" method="GET">
    ...
    <br>
    <?php endif ?>
    <form action="<?php echo baseUrl ?>fundacion/solicitudesFundacion/documentos" method="POST">
      <?php echo Token::field() ?>
      <?php if (isset($beneficiario) and $beneficiario): ?>
      ...
      <br>
      <button type="submit" class="btn btn-danger pull-right"><i class="fa fa-file"></i> CONSIGNAR DOCUMENTOS</button>
    </form>
  </div>
</div>
<script>
