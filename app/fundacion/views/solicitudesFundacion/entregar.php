...
<div id="panel" class="panel panel-danger">
  ...
  <div class="panel-body">
    <form action="<?php echo baseUrl ?>fundacion/solicitudesFundacion/entregar_proceso" method="POST">
      ...
      <button onclick="enviar()" id="botonSubmit" type="submit" class="btn btn-danger pull-right"><i class="fa fa-share-square"></i> CONFIRMAR ENTREGA<i class="fa fa-check"></i></button>
    </form>
  </div>
</div>
<script>
