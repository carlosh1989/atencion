...
<div id="panel" class="panel panel-danger">
  ...
  <div class="panel-body">
    <form action="<?php echo baseUrl ?>fundacion/solicitudesFundacion/monto_aprobado" method="POST">
      ...
      <br>
      <button type="submit" class="btn btn-danger pull-right"><i class="fa fa-money"></i> <i class="fa fa-check"></i> APROBAR MONTO</button>
    </form>
  </div>
</div>
