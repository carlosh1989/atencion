  ...
  <div class="panel-body">
    <div class="row">
      ...
      <div class="col-lg-6 animated fadeIn panel panel-default animated">
        <div class="">
          <h5 class="text-muted text-danger">
          <i class="fa fa-file"></i> SOLICITUDES
          <a class="btn btn-default pull-right" href="<?php echo baseUrl ?>fundacion/solicitudesFundacion/create/<?php echo $solicitante->id ?>"><i class="fa fa-files-o text-danger"></i> Agregar Solicitud</a>
          </h5>
          <hr>
        </div>
        <div class="">
          <table class="table table-striped table-condensed table-responsive animated fadeIn" data-striped="true">
            <thead>
              <tr>
                <th class="text-uppercase" width="5%">COD</th>
                <th class="text-uppercase" width="35%">Fecha</th>
                <th class="text-uppercase" >Paso Actual</th>
                <th class="text-uppercase" width="10%">Estatus</th>
                <th class="text-uppercase" width="10%">Ver</th>
              </tr>
            </thead>
            <tbody>
