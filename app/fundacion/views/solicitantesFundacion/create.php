...
//alert(tipo_id);
$.get("<?php echo baseUrl ?>fundacion/solicitudesFundacion/parroquias", { idMunicipio:idMunicipio }, function(data){
...
function enviar(argument) {
  ...
  //alert(inputEmail);
$.get("<?php echo baseUrl ?>fundacion/solicitudesFundacion/verificar_email", { email:email }, function(existe){
...
<div id="panel" class="panel panel-danger">
  ...
  <div class="panel-body">
    <form action="<?php echo baseUrl ?>fundacion/solicitantesFundacion" method="POST">
