...
class ReportesFundacion
{
    ...
    public function abiertasPDF2()
    {
        ...
        $solicitudes = Solicitud::orderBy('id', 'DESC')->where('estatus',1)->get();
        ob_start();
        include('app/fundacion/views/reportes/abiertas.php');
    ...
    public function lista_pensionados()
    {
        ...
        ob_start();
        include('app/fundacion/views/reportes/encabezado.php');
        ...
        ob_start();
        include("app/fundacion/views/reportes/pensionados.php");
