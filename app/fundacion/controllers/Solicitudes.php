...
class SolicitudesFundacion
{
    ...
    public function monto_aprobado()
    {
        ...
        if($solicitud->save())
        {
            Success('consultasFundacion/aprobadas/','La solicitud fue aprobada..!');
        }
        else
        {
            Error('consultasFundacion/aprobadas/','Error al aprobar solicitud!');
        }
    }
...
*/
            if($imagen->save())
            {
                Success('solicitudesFundacion/'.$solicitud->id,'Solicitud fue entregada.');
            }
            else
            {
                Error('consultasFundacion/aprobadas','Error.');
            }
        }
        else
        {
    ...
    public function store()
    {
        ...
        if(isset($requerimientos))
        {
            ...
            {
                Success('solicitantesFundacion/'.$solicitante_id,'La solicitud fue realizada..!');
            }
            else
            {
                Error('solicitantesFundacion/'.$solicitante_id,'Error al crear solicitud!');
            }
        }
        else
        {
