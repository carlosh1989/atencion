<div id="panel" class="panel panel-danger">
  ...
  <div class="panel-body">
          ...
          <div class="col-md-6">
            ...
            <div class="col-md-2">
              <div class="form-group">
                <a class="btn btn-block btn-default animated" href="javascript:{}" onclick="$('#formulario').submit();"><i class="fa fa-search fa-2x text-danger"></i></a>
              </div>
            </div>
          </div>
        </form>
    ...
    <br>
    <h5 class="text-muted text-danger text-center">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-uppercase" width="15%">
                <a class="btn btn-default" href="<?php echo baseUrl ?>admin/solicitantes/<?php echo $c->id ?>"><i class="fa fa-search text-danger"></i></a>
              </td>
            </tr>
            <?php endforeach ?>
          </tbody>
