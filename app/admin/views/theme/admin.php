        ...
        <div class="col-sm-3 col-lg-2">
          <nav class="navbar navbar-default navbar-fixed-side">
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                  <ul class="nav navbar-nav navbar-right">
                    ...
                    <ul class="nav collapse" id="opcionesMenu" role="menu" aria-labelledby="btn-1">
                      <li><a class="text-danger" href="<?php echo baseUrl ?>admin/cuentas"><i class="fa fa-user-plus"></i> Cuentas</a></li>
                      <li><a class="text-danger" href="<?php echo baseUrl ?>auth/login/logout"><i class="fa fa-power-off"></i> Salir</a></li>
                    </ul>
                  </li>
                </ul>
                <ul class="nav navbar-nav">
                  <li class="active"><a class="text-danger" href="<?php echo baseUrl ?>"><i class="fa fa-folder-open"></i> INGRESAR SOLICITUD</a></li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                  <li><a class="text-danger" href="#" id="" data-toggle="collapse" data-target="#consultasMenu" aria-expanded="false"><i class="fa fa-clipboard"></i> CONSULTAS</a>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li><a class="text-danger" href="#" id="" data-toggle="collapse" data-target="#solicitudesMenu" aria-expanded="false"><i class="fa fa-clipboard"></i> SOLICITUDES</a>
