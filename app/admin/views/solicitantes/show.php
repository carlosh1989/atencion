    ...
    <div class="row">
      ...
      <div class="col-lg-6 animated fadeIn panel panel-default animated">
        <div class="">
          ...
          <a class="btn btn-default pull-right" href="<?php echo baseUrl ?>admin/solicitudes/create/<?php echo $solicitante->id ?>"><i class="fa fa-files-o text-danger"></i> Agregar Solicitud</a>
          </h5>
          <hr>
        </div>
        <div class="">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-uppercase" class="text-uppercase" width="15%">
                  <a class="btn btn-default" href="<?php echo baseUrl ?>admin/solicitudes/<?php echo $c->id ?>"><i class="fa fa-search text-danger"></i></a>
                </td>
              </tr>
              <?php endforeach ?>
              <?php else: ?>
